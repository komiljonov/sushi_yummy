...
class StatisticsAPIView(APIView):
    ...
    def get(self, request: HttpRequest | Request):
        ...
        # Revenue calculation for today and yesterday
        today_revenue = today_orders.aggregate(total=Sum("price"))["total"] or 0
        yesterday_revenue = yesterday_orders.aggregate(total=Sum("price"))["total"] or 0
        ...
        return Response(
            {
                ...
                "active_users_delta": 43,  # Placeholder, if you want similar logic apply to active_users
            }
        )
